package com.spendwise.budget.config;
...
/**
 * SwaggerConfig — http://localhost:8084/swagger-ui.html
 * Use POST /api/auth/login (auth-service) to get a JWT, then click "Authorize".
 */
@Configuration
@OpenAPIDefinition(
    info = @Info(
        title = "SpendWise Budget Service API",
        version = "1.0.0",
        description = "REST API Documentation — Budget Management and Reconciliation",

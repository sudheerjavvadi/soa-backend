...
/**
 * SwaggerConfig — http://localhost:8086/swagger-ui.html
 * Use POST /api/auth/login (auth-service) to get a JWT, then click "Authorize".
 */
@Configuration
@OpenAPIDefinition(
    info = @Info(
        title = "SpendWise Notification Service API",
        version = "1.0.0",
        description = "REST API Documentation — Real-time Notification API with WebSocket/STOMP support",
